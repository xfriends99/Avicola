        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Productos
                    <a href= "/addproduct"  style="margin-top:-7px; float:right;" class="btn btn-success" >Nuevo Producto</a>
                </div>
          <form action="/products/search" method="get" class="sidebar-form">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo number_format($d->price_sales, 2, ',', '.') ?></td>
                                <td>{{ $d->type_calculation }}</td>
                                <td>{{ date('d-m-Y', strtotime($d->created_at))}}</td>
                                <td><a href= "{{url('product/'.$d->id)}}" class="btn btn-info" >Editar</a>&nbsp;&nbsp;
...
<script >
    $(document).ready(function(){
        $('.delete').click(function(event){
                ...
                if(confirm("¿Esto eliminar\xE1 el producto, continuar?")){
                      window.location.href="/deleteProduct/"+$(this).attr('data-id');
                }
            });
        });
</script>
